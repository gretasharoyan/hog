...
def roll_dice(num_rolls, dice=six_sided):
    ...
    #While loop to sum the number of point scored for the number of rolls in a turn.
    ...
    #Return 1 if there is a "Pig Out" (1 is rolled).
    if rolled_one:
        return 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    if feral_hogs:
        ...
        while score0<goal or score1<goal:
            ...
            add1 =   take_turn(num_rolls1, score0, dice)
            score1 = add1 + score1
            if abs(num_rolls1 - add11) == 2:
                score1+=3
            if is_swap(score1, score0):
                score1, score0 = score0, score1
            if score0 >= goal or score1>=goal >=goal:
                return score0, score1
            add00, add11 = add0, add1
    else:

        while score0<goal or score1<goal:
            num_rolls0 = strategy0(score0, score1)
            add0 = take_turn(num_rolls0, score1, dice)
            score0 = add0 + score0
            if is_swap(score0, score1):
                score0, score1 = score1, score0
            if score0 >= goal or score1>=goal:
